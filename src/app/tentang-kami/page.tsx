...
import { Shield, Lightbulb, Building2, FileCheck, Award, Code, X, Sparkles, ArrowRight, ChevronLeft, ChevronRight, MapPin, Mail, Phone, MessageCircle, Send, Loader, CheckCircle2, ArrowUpRight } from "lucide-react";
...
Kami berkomitmen menghadirkan sistem yang terintegrasi, akuntabel, dan berbasis data guna meningkatkan efisiensi operasional, transparansi administrasi, serta mendukung pengambilan keputusan yang lebih efektif melalui pemanfaatan teknologi digital.
      ...
      <section className="relative z-10 section-container mb-24 overflow-hidden">
        ...
        <motion.div
          aria-hidden
          className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[300px] rounded-full bg-brand-500/5 blur-3xl pointer-events-none"
          animate={{ scale: [1, 1.08, 1], opacity: [0.4, 0.7, 0.4] }}
          transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
        />

        <motion.div
          className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto mt-12 relative z-10"
        ...
        >
          {/* --- VISI --- */}
          <motion.div
            variants={{ hidden: { opacity: 0, y: 40, rotateX: 8 }, show: { opacity: 1, y: 0, rotateX: 0, transition: { duration: 0.6, ease: [0.22, 1, 0.36, 1] } } }}
            whileHover={{ y: -8, boxShadow: "0 30px 60px -15px rgba(59,130,246,0.18)", rotateX: -2 }}
            style={{ transformPerspective: 1000 }}
            className="glass rounded-3xl p-8 border border-navy-500/5 bg-white shadow-sm transition-shadow duration-300 relative overflow-hidden group"
          >
            <div className="absolute top-0 right-0 w-28 h-28 bg-brand-500/5 rounded-bl-[100%] group-hover:bg-brand-500/10 transition-colors duration-500" />
            <motion.div
              whileHover={{ rotate: [0, -10, 10, 0], scale: 1.15 }}
              transition={{ duration: 0.5 }}
              className="w-14 h-14 rounded-2xl bg-gradient-to-br from-brand-400 to-brand-600 flex items-center justify-center text-white mb-6 shadow-md shadow-brand-500/30"
            >
              <Lightbulb size={26} />
            </motion.div>
            <h3 className="text-xl font-extrabold text-navy-500 mb-3">Visi Kami</h3>
            ...
            <motion.div
              className="mt-6 h-1 rounded-full bg-gradient-to-r from-brand-400 to-brand-600 origin-left"
              initial={{ scaleX: 0 }}
          ...
          >
            ...
            <motion.div
              whileHover={{ rotate: [0, -10, 10, 0], scale: 1.15 }}
              transition={{ duration: 0.5 }}
              className="w-14 h-14 rounded-2xl bg-gradient-to-br from-navy-400 to-navy-600 flex items-center justify-center text-white mb-6 shadow-md shadow-navy-500/20"
            >
              <Code size={26} />
            </motion.div>
            <h3 className="text-xl font-extrabold text-navy-500 mb-4">Layanan</h3>
            <ul className="space-y-2.5">
              {["UI UX Design", "Website Development", "Marketing", "Social Media", "eCommerce Store", "Tech Support", "Capacity Building"].map((item, i) => (
                <motion.li
                  key={i}
                  ...
                  className="flex items-center gap-2.5 text-navy-500/80 text-sm font-medium"
                >
            ...
            <motion.div
              className="mt-6 h-1 rounded-full bg-gradient-to-r from-navy-400 to-navy-600 origin-left"
              initial={{ scaleX: 0 }}
              whileInView={{ scaleX: 1 }}
              viewport={{ once: true }}
          ...
          >
            ...
            <motion.div
              whileHover={{ rotate: [0, -10, 10, 0], scale: 1.15 }}
              transition={{ duration: 0.5 }}
              className="w-14 h-14 rounded-2xl bg-gradient-to-br from-brand-500 to-indigo-500 flex items-center justify-center text-white mb-6 shadow-md shadow-brand-500/30"
            >
              <Shield size={26} />
            </motion.div>
            <h3 className="text-xl font-extrabold text-navy-500 mb-4">Misi Kami</h3>
            <ul className="space-y-2.5">
              {[
                ...
                "Mengembangkan kurikulum berbasis data untuk meningkatkan kompetensi SDM",
                ...
                <motion.li
                  ...
                  className="flex items-start gap-2.5 text-navy-500/80 text-sm font-medium"
                >
            ...
            <motion.div
              className="mt-6 h-1 rounded-full bg-gradient-to-r from-brand-500 to-indigo-500 origin-left"
              initial={{ scaleX: 0 }}
              whileInView={{ scaleX: 1 }}
              viewport={{ once: true }}
...
Kami hadir untuk membangun keduanya."
      ...
      {/* ===== SECTION KONTAK & FORM PENAWARAN ===== */}
      <section id="kontak" className="relative z-10 section-container mb-24 pt-8">
        <SectionHeading
          badge="Hubungi Kami"
        ...
        <div className="grid lg:grid-cols-5 gap-8 items-start mb-12 mt-10">
          ...
          >
            <div className="group glass rounded-2xl bg-white p-5 border border-navy-500/5 shadow-sm transition-all hover:shadow-md">
              <div className="flex items-start gap-4">
                <div className="w-11 h-11 rounded-xl bg-brand-50/60 flex items-center justify-center text-brand-500 flex-shrink-0">
                  <MapPin size={20} />
                </div>
            ...
            <a href="mailto:info@instapro.co.id" className="block group glass rounded-2xl bg-white p-5 border border-navy-500/5 shadow-sm transition-all hover:shadow-md hover:border-brand-500/20">
              <div className="flex items-start gap-4">
                <div className="w-11 h-11 rounded-xl bg-brand-50/60 flex items-center justify-center text-brand-500 flex-shrink-0">
                  <Mail size={20} />
                </div>
                <div className="min-w-0">
                  ...
                  <p className="text-navy-500 text-xs font-semibold mt-0.5 leading-relaxed">info@instapro.co.id</p>
                </div>
                <ArrowUpRight size={16} className="ml-auto text-navy-500/30 group-hover:text-brand-500" />
              </div>
            </a>

            <a href="tel:+628217710106" className="block group glass rounded-2xl bg-white p-5 border border-navy-500/5 shadow-sm transition-all hover:shadow-md hover:border-brand-500/20">
              <div className="flex items-start gap-4">
                <div className="w-11 h-11 rounded-xl bg-brand-50/60 flex items-center justify-center text-brand-500 flex-shrink-0">
                  <Phone size={20} />
                </div>
                <div className="min-w-0">
                  ...
                  <p className="text-navy-500 text-xs font-semibold mt-0.5 leading-relaxed">+62 821-7710-106</p>
                </div>
                <ArrowUpRight size={16} className="ml-auto text-navy-500/30 group-hover:text-brand-500" />
              </div>
            </a>
          ...
          >
            <div className="relative glass rounded-3xl bg-white p-6 md:p-8 border border-navy-500/5 shadow-sm overflow-hidden">
              <h3 className="text-navy-500 font-extrabold text-base mb-6 relative">Kirim Pesan Resmi / Penawaran</h3>
              ...
              {contactSuccess ? (
                <div className="text-center py-8 space-y-4">
                  ...
                  <button onClick={() => setContactSuccess(false)} className="btn-secondary text-xs px-4 py-2">
                    Kirim Pesan Lain
                  </button>
                </div>
              ) : (
                <form onSubmit={handleContactSubmit} className="space-y-4 relative">
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div className="space-y-1">
                      <label className="text-[10px] font-bold uppercase tracking-wider text-navy-500/50">
                        Nama / Instansi
                      </label>
                      <input
                        type="text"
                  ...
                  <button
                    ...
                    className="btn-primary w-full justify-center py-4 text-xs disabled:opacity-70"
                  >
                    {contactLoading ? (
                      <>
        ...
        {/* Map Embed */}
        <div className="relative glass rounded-3xl bg-white overflow-hidden aspect-[21/9] w-full border border-navy-500/5 shadow-sm group">
          <iframe
